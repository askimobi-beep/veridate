...
const companyOptions = ["Custom"];
const instituteOptions = ["Custom"];
const locationOptions = ["Custom"];
...
function FilterSelect({
  ...
  return (
    <div className="space-y-2">
      ...
      >
        <SelectTrigger className="h-10 rounded-xl border-white/70 bg-white/70 text-slate-700 shadow-[0_12px_30px_-20px_rgba(15,23,42,0.55)] backdrop-blur-md focus:ring-orange-200">
      ...
      {allowCustom && selectValue === "__custom__" ? (
        <Input
          ...
          className="h-10 rounded-xl border-white/70 bg-white/70 text-slate-700 shadow-[0_12px_30px_-20px_rgba(15,23,42,0.55)] backdrop-blur-md"
        />
      ) : null}
    </div>
  );
    ...
    <form onSubmit={onSearch} className="space-y-4">
      ...
      <div className="flex gap-2 pt-3">
        ...
        <Button
          ...
          variant="outline"
          onClick={onReset}
          className="flex-1 rounded-xl border-white/70 bg-white/70 text-slate-700 hover:bg-white/90"
        >
          Reset
        </Button>
      </div>
